    ...
    <div className="max-w-3xl mx-auto px-4 py-6 pb-16">
      ...
      {(insight?.ai_climate_profile || insight?.ai_soil_profile || insight?.ai_signature_style) && (
        <Section title="Terroir">
          {insight?.ai_soil_profile && (
            <div className="mb-2"><MiniLabel>Soil</MiniLabel><p className="text-sm text-earth-700">{insight.ai_soil_profile} <AiLabel /></p></div>
          )}
      ...
      {insight?.ai_key_grapes && (
        <Section title="Key grapes">
          <p className="text-sm text-earth-600">{insight.ai_key_grapes} <AiLabel /></p>
        </Section>
      )}
      ...
      {insight?.ai_aging_generalization && (
        <Section title="Aging">
          <p className="text-sm text-earth-600">{insight.ai_aging_generalization} <AiLabel /></p>
        </Section>
      )}
