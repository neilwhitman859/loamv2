  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 pb-16">
      ...
      {(insight?.ai_flavor_profile || insight?.ai_growing_conditions) && (
        <Section title="Profile">
          {insight?.ai_flavor_profile && (
            <div className="mb-2"><MiniLabel>Flavor</MiniLabel><p className="text-sm text-earth-700">{insight.ai_flavor_profile}</p></div>
          )}
          {insight?.ai_growing_conditions && (
            <div className="mb-2"><MiniLabel>Growing conditions</MiniLabel><p className="text-sm text-earth-700">{insight.ai_growing_conditions}</p></div>
          )}
        </Section>
      )}
      ...
      {insight?.ai_aging_characteristics && (
        <Section title="Aging">
          <p className="text-sm text-earth-600">{insight.ai_aging_characteristics}</p>
        </Section>
      )}
