...
- **schema-decisions.md** — Complete log of every schema decision with rationale
- **schema-summary.md** — Consolidated table-by-table field reference
- **This document** — Vision, goals, and principles
