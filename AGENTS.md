...
- implement the v3 continuity redesign from `data/sprints/dedup/session9_v3_continuity_audit.md` and rerun an expanded proof subset only; no full 152-case rerun or queue-building until that proof passes
