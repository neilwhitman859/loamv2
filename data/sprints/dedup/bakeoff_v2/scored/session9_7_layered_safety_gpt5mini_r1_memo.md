...
- Generated: 2026-04-21T11:58:50-04:00
- Run name: `session9_7_layered_safety_gpt5mini_r1`
- Contender id: `layered_safety_gpt5mini_r1_v1`
- Starting point: `session9_6_pattern_specialist_proof_if_approved` layered on `session9_3_full_rerun_if_approved`
- Safety reviewer: `gpt5mini_guardrailed_v2`
...
| Blind-core missed merges (hard + soft) | 5 | 10 |
| Routed merge recoveries | 42 / 47 | 35 / 47 |
| Full-benchmark flag rate | 0.1053 | 0.1711 |
| Exact verdict accuracy | 0.8224 | 0.7829 |
...
- `blind_core_audit_005`: `veto_to_base` (Guy Castagnier <-> Castagnier)
