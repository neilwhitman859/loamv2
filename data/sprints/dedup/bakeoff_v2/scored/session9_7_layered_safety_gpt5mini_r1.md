# session9_7_layered_safety_gpt5mini_r1 - Session 4 bakeoff proof scorecard
...
|---|---:|---:|---:|---:|---:|---:|---|
| layered_safety_gpt5mini_r1_v1 | 0.7829 | 0 | 7 | 9 | 17 | 1.0000 | fail |

## Winner selection table

| Contender | Eligibility | Production gate | Fallback gate |
|---|---|---|---|
| layered_safety_gpt5mini_r1_v1 | fallback_only | fail | pass |