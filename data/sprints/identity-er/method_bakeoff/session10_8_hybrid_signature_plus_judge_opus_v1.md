...
- Generated: 2026-04-21T21:42:26-04:00
- Run name: `session10_8_hybrid_signature_plus_judge_opus_v1`
...
- Counts: false merge `1`, hard missed `4`, soft missed `0`, safe flag `23`.
- Rates: exact acc `0.8158`, merge capture `0.9216`, survivor acc `1.0000`, flag rate `0.1513`.
...
| `blind_core_audit_037` | SKIP | SKIP | FLAGGED |
