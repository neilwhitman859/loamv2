...
- Generated: 2026-04-21T21:52:54-04:00
- Run name: `session10_8_hybrid_signature_plus_judge_sonnet_rerun_v1`
...
- Counts: false merge `1`, hard missed `4`, soft missed `0`, safe flag `18`.
- Rates: exact acc `0.8487`, merge capture `0.9216`, survivor acc `1.0000`, flag rate `0.1184`.
...
| `blind_core_audit_032` | SKIP | SKIP | SKIP |
| `blind_core_audit_037` | SKIP | SKIP | SKIP |
| `blind_core_audit_041` | SKIP | SKIP | SKIP |
| `blind_core_audit_051` | SKIP | SKIP | SKIP |
| `blind_core_audit_056` | SKIP | SKIP | SKIP |
| `blind_core_audit_061` | SKIP | SKIP | SKIP |
| `blind_core_audit_062` | SKIP | FLAGGED | MERGE |
| `blind_core_audit_063` | SKIP | SKIP | FLAGGED |
| `blind_core_audit_066` | SKIP | SKIP | SKIP |
| `blind_core_audit_069` | SKIP | SKIP | FLAGGED |
| `blind_core_audit_089` | SKIP | SKIP | SKIP |
