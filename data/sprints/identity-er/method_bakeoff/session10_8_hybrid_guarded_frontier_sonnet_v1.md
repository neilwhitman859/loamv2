...
- Run name: `session10_8_hybrid_guarded_frontier_sonnet_v1`
- Source run: `session10_8_hybrid_signature_plus_judge_sonnet_v1`
- Source model: `claude-sonnet-4-6`
- Method version: `hybrid_guarded_frontier_v1`
- Estimated inherited model spend: `$0.5392`
