...
- Run name: `session10_8_hybrid_guarded_fils_person_alias_sonnet_rerun_v1`
- Source run: `session10_8_hybrid_guarded_maison_alias_sonnet_rerun_v1`
- Source model: `claude-sonnet-4-6`
- Method version: `hybrid_guarded_fils_person_alias_v1`
- Incremental model spend: `$0.0000`
- Inherited source-run spend: `$0.5382`
...
- Counts: false merge `0`, hard missed `0`, soft missed `0`, safe flag `18`.
- Rates: exact acc `0.8816`, merge capture `1.0000`, flag rate `0.1184`.
