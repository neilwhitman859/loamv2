...
- Generated: 2026-04-21T21:49:51-04:00
- Run name: `session10_8_hybrid_guarded_frontier_opus_v1`
- Source run: `session10_8_hybrid_signature_plus_judge_opus_v1`
- Source model: `claude-opus-4-6`
- Method version: `hybrid_guarded_frontier_v1`
- Estimated inherited model spend: `$2.9662`
...
- `blind_core_audit_037`: `FLAGGED` -> `SKIP` via `invalid_output_reuse_control`
...
- `blind_core_audit_063`: `FLAGGED` -> `SKIP` via `invalid_output_reuse_control`
...
| `blind_core_audit_037` | SKIP | SKIP | FLAGGED | SKIP |
...
| `blind_core_audit_063` | SKIP | SKIP | FLAGGED | SKIP |
