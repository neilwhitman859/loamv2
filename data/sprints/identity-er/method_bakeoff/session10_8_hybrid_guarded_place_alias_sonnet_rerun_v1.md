...
- Run name: `session10_8_hybrid_guarded_place_alias_sonnet_rerun_v1`
- Source run: `session10_8_hybrid_guarded_cuvee_anchor_sonnet_rerun_v1`
...
- Counts: false merge `0`, hard missed `2`, soft missed `0`, safe flag `18`.
- Rates: exact acc `0.8684`, merge capture `0.9608`, flag rate `0.1184`.
