...
- Run name: `session10_8_hybrid_guarded_maison_alias_opus_rerun_v1`
- Source run: `session10_8_hybrid_guarded_place_alias_opus_rerun_v1`
...
- Counts: false merge `0`, hard missed `1`, soft missed `0`, safe flag `17`.
- Rates: exact acc `0.8816`, merge capture `0.9804`, flag rate `0.1118`.
