...
- **Path A session (2026-04-05): Seed appellation_rules from legal sources.** Provenance columns added (source_url, source_organization, source_document_title, source_accessed_date, source_text_excerpt, last_verified_at) to `appellation_rules` and `appellation_grapes`. **19 appellation_rules seeded** (0 → 19), all with 100% provenance coverage traceable to legal documents: 18 INAO cahiers des charges (Sancerre, Chablis, Champagne, Bourgogne, Pommard, Meursault, Gevrey-Chambertin, Puligny-Montrachet, Chassagne-Montrachet, Volnay, Muscadet, Vouvray, Pouilly-Fumé, Pouilly-sur-Loire, Pouilly-Fuissé, Nuits-Saint-Georges, Châteauneuf-du-Pape, Gigondas) + 1 MAPA pliego de condiciones DOCa Rioja. **83 appellation_grapes rows** also carry full provenance. Legal texts extracted from local PDFs via `pypdf`, saved under `data/legal_sources/` for reproducibility. Cascades executed (strictly definitional, NULL-fills only): **+2,466 wines.color** fills on 9 single-color regulated appellations (Chablis 560 → white, Gevrey-Chambertin 583 → red, Pouilly-Fuissé 285, Volnay 272, Vouvray 249, Pommard 366, Pouilly-Fumé 117, Muscadet 28, Pouilly-sur-Loire 6). **+3,610 wines.varietal_category_id** fills on strict single-variety + effective-single-variety appellations (Chablis 2018 → Chardonnay, Pouilly-Fuissé 374 → Chardonnay, Pouilly-Fumé 106 → Sauv Blanc, Sancerre 697 color-dependent, Muscadet 45 → Melon de Bourgogne, Vouvray 436 → Chenin Blanc). **+2,869 new wine_grapes rows** created at percentage=100 for true 100% single-variety appellations (Chablis 1796, Pouilly-Fuissé 277, Pouilly-Fumé 106, Pouilly-sur-Loire 1, Sancerre 689 color-dependent). Italian DOCGs (Barolo, Brunello, Chianti Classico) deferred — MASAF ECONNREFUSED, eAmbrosia JS-rendered, EUR-Lex searches unproductive. Cross-check found **~850 wines with legally impossible colors** (50 Chablis red, 800 Champagne red) — left alone per no-overwrite rule, flagged in DECISIONS.md for cleanup session.
